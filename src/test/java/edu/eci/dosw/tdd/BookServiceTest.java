...
class BookServiceTest {
    ...
    void getAllBooks_shouldReturnAllBooks() {
        bookService.addBook(new Book("1", "Clean Code", "Robert Martin"), 2);
        bookService.addBook(new Book("2", "Clean Architecture", "Robert Martin"), 1);
    ...
    void getBookById_shouldThrowException_whenNotExists() {
        assertThrows(BookNotAvailableException.class, () -> bookService.getBookById("999"));
    }
    ...
    void decrementCopies_shouldMakeBookUnavailable_whenLastCopy() {
        bookService.addBook(new Book("1", "Clean Code", "Robert Martin"), 1);
    ...
    void decrementCopies_shouldThrowException_whenNoCopies() {
        bookService.addBook(new Book("1", "Clean Code", "Robert Martin"), 0);

        assertThrows(BookNotAvailableException.class, () -> bookService.decrementCopies("1"));
    }
}